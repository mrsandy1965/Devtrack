// Central SVG Icon Library – all icons sized via the `size` prop (default 20)
...
export function IconTimer({ size = 20, color = 'currentColor' }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function IconReset({ size = 20, color = 'currentColor' }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M3 2v6h6" />
...
export function IconCode({ size = 20, color = 'currentColor' }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
// Type icon map for habits
export const HabitTypeIcon = ({ type, size = 24 }) => {
  const props = { size, color: 'var(--accent-light)' };
  switch (type) {
    case 'dsa':      return <IconCode {...props} />;
    case 'project':  return <IconTool {...props} />;
    case 'learning': return <IconBook {...props} />;
