...
function AppModal({ onClose, onSave }: { onClose: () => void; onSave: (data: any) => Promise<void> }) {
...
export default function InternshipsPage() {
  ...
  const grouped = STATUSES.reduce((acc: Record<string, any[]>, s) => ({ ...acc, [s]: apps.filter((a) => a.status === s) }), {});
